...
class LandAdminDeskTop(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('landadmindesktopdetails', args=[str(self.id)])


class LandAdminBarCodeScanner(models.Model):
    ...
    def __str__(self):
        return {}, ({}).format(self.serial_number, self.date)

    def get_absolute_url(self):
        return reverse('landadminbarcodescannerdetails', args=[str(self.id)])
